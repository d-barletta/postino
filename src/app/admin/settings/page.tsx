...
export default function AdminSettingsPage({ showPageHeader = true }: AdminSettingsPageProps) {
  ...
  const [settings, setSettings] = useState<Partial<Settings>>({
    ...
    smtpUser: '',
    smtpPass: '',
    smtpFrom: '📬 Postino <noreply@postino.pro>',
    smtpFromName: '📬 Postino - {senderName}',
    smtpFromEmail: 'noreply@postino.pro',
    emailDomain: 'postino.pro',
    mailgunApiKey: '',
    mailgunWebhookSigningKey: '',
    mailgunDomain: 'postino.pro',
    mailgunSandboxEmail: 'postino.pro',
