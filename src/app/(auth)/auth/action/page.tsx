...
export const metadata: Metadata = {
  ...
  description: 'Complete your account action for Postino.',
  alternates: {
    ...
    <div className="flex-1 from-yellow-50 via-white to-amber-100 dark:from-gray-950 dark:via-gray-900 dark:to-gray-800 flex items-center justify-center p-4">
      <div className="w-full max-w-md ui-fade-up">
        <div className="text-center mb-8">
          ...
          <h1 className="text-1xl font-bold text-gray-900">Processing account action</h1>
          <p className="text-gray-500 dark:text-gray-400 mt-1">Please wait while we validate your link</p>
        </div>
