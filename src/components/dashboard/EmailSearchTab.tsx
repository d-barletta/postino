...
export function EmailSearchTab({ selectedEmailId, refreshTrigger }: EmailSearchTabProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="hidden min-[900px]:flex glass-panel rounded-2xl border-gray-200 dark:border-gray-700 overflow-y-auto shadow-sm bg-white dark:bg-gray-900 min-h-150 max-h-[900px]">
        {/* Left pane: list */}
