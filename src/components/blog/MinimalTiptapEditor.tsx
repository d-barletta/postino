  ...
  return (
    <div
      className={cn(
        ...
        'prose-headings:font-bold prose-headings:text-gray-900 dark:prose-headings:text-gray-100',
        'prose-p:text-gray-700 dark:prose-p:text-gray-300',
        'prose-a:text-[#a3891f] dark:prose-a:text-[#f3df79] prose-a:underline prose-a:underline-offset-2 prose-a:decoration-[#a3891f]/50 dark:prose-a:decoration-[#f3df79]/50 hover:prose-a:decoration-[#a3891f] dark:hover:prose-a:decoration-[#f3df79] prose-a:transition-colors',
        'prose-strong:text-gray-900 dark:prose-strong:text-gray-100 prose-strong:font-semibold',
        'prose-em:text-gray-700 dark:prose-em:text-gray-300',
        'prose-code:bg-gray-100 dark:prose-code:bg-gray-800 prose-code:text-gray-800 dark:prose-code:text-gray-200 prose-code:rounded prose-code:px-1.5 prose-code:py-0.5 prose-code:text-sm prose-code:before:content-none prose-code:after:content-none',
        'prose-pre:bg-gray-100 dark:prose-pre:bg-gray-800 prose-pre:rounded-xl prose-pre:shadow-sm',
        'prose-blockquote:border-l-4 prose-blockquote:border-[#efd957] prose-blockquote:pl-4 prose-blockquote:text-gray-600 dark:prose-blockquote:text-gray-400 prose-blockquote:not-italic prose-blockquote:font-normal',
        'prose-ul:text-gray-700 dark:prose-ul:text-gray-300 prose-ol:text-gray-700 dark:prose-ol:text-gray-300',
        'prose-li:text-gray-700 dark:prose-li:text-gray-300 prose-li:marker:text-[#a3891f] dark:prose-li:marker:text-[#f3df79]',
