    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          'sm:rounded-2xl border border-gray-200 dark:border-gray-700',
          animation !== 'slide-from-bottom' && 'rounded-t-2xl',
          animation === 'default' && [
      ...
      >
        {children}
        {!hideCloseButton && (
          <DialogPrimitive.Close className="absolute right-4 top-4 rounded-lg opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-inset focus:ring-1 focus:ring-[#efd957] disabled:pointer-events-none data-[state=open]:bg-gray-100 dark:data-[state=open]:bg-gray-800">
