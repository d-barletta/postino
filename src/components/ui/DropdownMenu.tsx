...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      'z-50 min-w-32 overflow-hidden rounded-xl border border-gray-200 dark:border-gray-700',
      'bg-white dark:bg-gray-900 p-1 shadow-lg text-gray-900 dark:text-gray-100',
...
>(({ className, inset, variant = 'default', ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      variant === 'destructive' &&
        'text-red-600 dark:text-red-400 focus:bg-red-50 dark:focus:bg-red-950/30',
      inset && 'pl-8',
      className,
    )}
    {...props}
