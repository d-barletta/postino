  ...
  de: {
    ...
    dashboard: {
      ...
      deleteEntities: {
        ...
        description:
          'Löscht dauerhaft alle extrahierten Entitäten (Personen, Themen, Organisationen, Orte, Ereignisse, Daten, Tags) aus Ihren E-Mails, alle Entitätszusammenführungen und alle KI-Zusammenführungsvorschläge. Diese Aktion kann nicht rückgängig gemacht werden.',
      ...
      search: {
        ...
        datesPlaceholder: 'Daten auswählen…',
